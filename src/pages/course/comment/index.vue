...
.comment-publish-container.dark-theme .loading-overlay { background-color: rgba(0,0,0,0.7); .loading-spinner { border-color: rgba(255,255,255,0.15); border-top-color: #fff; } .loading-text { color: #fff; } }
</style>
